--------------------------------------------------------
--  File created - Monday-November-16-2015   
--------------------------------------------------------
--------------------------------------------------------
...
Insert into TESTUSERDB.HCOURSE (COURSECODE,SUBJECTCODE,COURSENAME,DESCRIPTION,CREDITS,DEPARTCODE,STATUSCODE) values (2,'prg 102','java advanced',null,3,1,1);
...
SET DEFINE OFF;
Insert into TESTUSERDB.HDEPARTMENT (DEPARTCODE,DEPARTMENTNAME,STATUSCODE) values (1,'computer science',1);
Insert into TESTUSERDB.HDEPARTMENT (DEPARTCODE,DEPARTMENTNAME,STATUSCODE) values (2,'engineering',1);
Insert into TESTUSERDB.HDEPARTMENT (DEPARTCODE,DEPARTMENTNAME,STATUSCODE) values (3,'data science',1);
Insert into TESTUSERDB.HDEPARTMENT (DEPARTCODE,DEPARTMENTNAME,STATUSCODE) values (4,'math',1);
...
--------------------------------------------------------
  ...
  CREATE UNIQUE INDEX "TESTUSERDB"."HDEPARTMENT_PK" ON "TESTUSERDB"."HDEPARTMENT" ("DEPARTCODE") 
  PCTFREE 10 INITRANS 2 MAXTRANS 255 
  STORAGE(INITIAL 65536 NEXT 1048576 MINEXTENTS 1 MAXEXTENTS 2147483645
  PCTINCREASE 0 FREELISTS 1 FREELIST GROUPS 1 BUFFER_POOL DEFAULT FLASH_CACHE DEFAULT CELL_FLASH_CACHE DEFAULT)
  TABLESPACE "USERS" ;
...
--------------------------------------------------------
  ...
  ALTER TABLE "TESTUSERDB"."HDEPARTMENT" ADD CONSTRAINT "HDEPARTMENT_PK" PRIMARY KEY ("DEPARTCODE")
  USING INDEX PCTFREE 10 INITRANS 2 MAXTRANS 255 
  STORAGE(INITIAL 65536 NEXT 1048576 MINEXTENTS 1 MAXEXTENTS 2147483645
  PCTINCREASE 0 FREELISTS 1 FREELIST GROUPS 1 BUFFER_POOL DEFAULT FLASH_CACHE DEFAULT CELL_FLASH_CACHE DEFAULT)
  TABLESPACE "USERS"  ENABLE;
  ALTER TABLE "TESTUSERDB"."HDEPARTMENT" MODIFY ("DEPARTCODE" NOT NULL ENABLE);
--------------------------------------------------------
...
--------------------------------------------------------
  ...
  ALTER TABLE "TESTUSERDB"."HCOURSE" ADD CONSTRAINT "HCOURSE_FK1" FOREIGN KEY ("DEPARTCODE")
	  REFERENCES "TESTUSERDB"."HDEPARTMENT" ("DEPARTCODE") ENABLE;
--------------------------------------------------------
...
BEGIN
  <<COLUMN_SEQUENCES>>
  BEGIN
    IF INSERTING AND :NEW.DEPARTCODE IS NULL THEN
      SELECT HDEPARTMENT_SEQ.NEXTVAL INTO :NEW.DEPARTCODE FROM SYS.DUAL;
    END IF;
  END COLUMN_SEQUENCES;
END;
/
