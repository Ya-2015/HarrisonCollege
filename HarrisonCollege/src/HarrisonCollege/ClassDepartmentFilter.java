...
/**
 * Servlet implementation class ClassDepartmentFilter
 */
@WebServlet("/ClassDepartmentFilter")
public class ClassDepartmentFilter extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public ClassDepartmentFilter() {
        super();
