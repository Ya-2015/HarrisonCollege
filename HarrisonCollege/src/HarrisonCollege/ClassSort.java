	...
	protected void doPost(HttpServletRequest request,
		...
		for (Hinstructor i : ins) {
			instructorDropdown = instructorDropdown
					+ "<li><input type=\"checkbox\" name=\"instructorid\" id=\"instructorid\" value="
					+ i.getNetid() + "><label for=\"instructorid\">"
		...
		for (String sub : subject) {
			subjectDropdown = subjectDropdown
					+ "<li><input type=\"checkbox\" name=\"subjectid\" id=\"subjectid\" value="
					+ sub + "><label for=\"subjectid\">" + sub
					+ "</label></li>";
		}
		...
		for (Hschedule s : sch) {
			timeDropdown = timeDropdown
					+ "<li><input type=\"checkbox\" name=\"timeid\" id=\"timeid\" value="
					+ s.getHour12() + "><label for=\"timeid\">"
