...
/**
 * Servlet implementation class ClassSubjectFilter
 */
@WebServlet("/ClassSubjectFilter")
public class ClassSubjectFilter extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public ClassSubjectFilter() {
        super();
	...
	String classTable = "";
		ArrayList<Hclass> data = uDB.getClassBySubjectBySemester((String)request.getParameter("subjectID"),1);
